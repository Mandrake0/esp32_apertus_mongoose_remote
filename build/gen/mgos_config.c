...
const struct mgos_conf_entry mgos_config_schema_[159] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 158},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "ili9341", .offset = offsetof(struct mgos_config, ili9341), .num_desc = 6},
  {.type = CONF_TYPE_INT, .key = "cs_index", .offset = offsetof(struct mgos_config, ili9341.cs_index)},
  {.type = CONF_TYPE_INT, .key = "spi_freq", .offset = offsetof(struct mgos_config, ili9341.spi_freq)},
  {.type = CONF_TYPE_INT, .key = "dc_pin", .offset = offsetof(struct mgos_config, ili9341.dc_pin)},
  {.type = CONF_TYPE_INT, .key = "rst_pin", .offset = offsetof(struct mgos_config, ili9341.rst_pin)},
  {.type = CONF_TYPE_INT, .key = "width", .offset = offsetof(struct mgos_config, ili9341.width)},
  {.type = CONF_TYPE_INT, .key = "height", .offset = offsetof(struct mgos_config, ili9341.height)},
